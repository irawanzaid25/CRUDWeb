...
<html>
<head>
    <title>Sign Up - CRUD Data Siswa</title>
    <style>
        body { font-family: Arial, sans-serif; background-color: #f4f4f4; }
        .signup-container { width: 300px; margin: 50px auto; padding: 20px; background: #fff; border-radius: 5px; box-shadow: 0 0 10px rgba(0,0,0,0.1); }
...
<body>
    <div class="signup-container">
        ...
        <?php if (isset($_GET['error'])): ?>
            <p class="error">Username sudah digunakan!</p>
        <?php endif; ?>
